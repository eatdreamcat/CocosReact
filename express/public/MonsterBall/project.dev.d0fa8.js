window.__require = function e(t, n, r) {
  ...
  GameFactory: [ function(require, module, exports) {
    ...
    var GameFactory = function() {
      ...
      GameFactory.prototype.initUI = function() {
        var self = this;
        var count = 0;
        ...
        var _loop_1 = function(path) {
          cc.loader.loadRes(path, cc.Prefab, function(err, prefab) {
            if (err) console.error(err); else {
              ...
              self.UIpool.add(path, new ObjPool(uiNode, 1));
              count++;
    ...
    var GameMgr = function() {
      ...
      GameMgr.prototype.nextLevel = function() {
        ...
        function nextTick() {
          ...
          self.initBalls(self.sceneID != self.levelStaticInfo.map);
      ...
      GameMgr.prototype.removeBall = function(ballID) {
        var balls = this.balls.get(ballID);
        balls && balls.length <= 0 ? this.balls.remove(ballID) : balls.pop();
        this.checkBalls();
      };
      ...
      GameMgr.prototype.numbMonster = function(monster) {
        ...
        var buffOption = {
          ...
          handler: function() {
            monster.setState(Monster_1.MonsterState.NUMB);
            EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.MONSTER_NUMB, true);
          },
          completeHandler: function() {
            monster.delState(Monster_1.MonsterState.NUMB);
            EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.MONSTER_NUMB, false);
          },
  ...
  Item: [ function(require, module, exports) {
    ...
    var Item = function(_super) {
      ...
      Item.prototype.update = function(dt) {
        var _this = this;
        if (!this.node || !this.node.isValid || !this.itemID || GUIDE) return;
        this.node.y -= 2;
        if (CameraController_1.gCamera.checkIsYInRange(this.node) && this.guideID > 0) {
      ...
      Item.prototype.onBeginContact = function(contact, self, other) {
        if (this.itemData) {
          ...
          switch (this.itemData.form) {
           ...
           case table_1.Monster_ball_prop_form.GongJiWu:
  ...
  MonsterSpine: [ function(require, module, exports) {
    ...
    var MonsterSpine = function(_super) {
      ...
      MonsterSpine.prototype.initEvent = function() {
        ...
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.MONSTER_DIE, this.die, this);
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.MONSTER_UPDATE_STAGE, this.updateStage, this);
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.MONSTER_NUMB, function(isNumb) {
          console.log(" is Numbe :", isNumb);
          var aniState = _this.splash.getAnimationState("splash");
          if (aniState.isPlaying && isNumb) return;
          if (isNumb) _this.splash.play("splash").wrapMode = cc.WrapMode.Loop; else {
            _this.splash.stop();
            _this.splash.play("splash").wrapMode = cc.WrapMode.Normal;
          }
        }, this);
  ...
  table: [ function(require, module, exports) {
    ...
    (function(Monster_ball_prop_form) {
      ...
      Monster_ball_prop_form[Monster_ball_prop_form["GongJiWu"] = 5] = "GongJiWu";
